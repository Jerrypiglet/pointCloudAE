...
dll=np.ctypeslib.load_library('./depthestimate/render_balls_so','.')

def showpoints(xyz,c0=None,c1=None,c2=None,waittime=0,showrot=False,magnifyBlue=0,freezerot=False,background=(0,0,0),normalizecolor=True,ballradius=5):
